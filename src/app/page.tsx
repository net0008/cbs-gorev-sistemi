...
export default function Home() {
  return (
    <div className="relative w-full h-[calc(100vh-150px)] flex items-center justify-center -mt-4 -mb-4">
      ...
      <div className="relative z-10 w-full max-w-2xl p-8 bg-background/20 dark:bg-black/20 backdrop-blur-md rounded-3xl shadow-xl border border-border/10 text-center">
