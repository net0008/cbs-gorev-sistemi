      ...
      <div style={{ flex:1, overflowY:"auto", padding:"26px 32px", display:"flex", flexDirection:"column", gap:"20px", background:`radial-gradient(ellipse at 20% 20%,${COLOR_LOCATION}08 0%,${BG_DARK} 70%)` }}>
        ...
        {section==="goreceli" && <>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr", gap:"12px", alignItems:"start" }}>
            <iframe title="Türkiye'nin Kara Komşuları" style={{ width: "100%", height: "800px", border: 0, borderRadius: "12px" }} allowFullScreen allow="geolocation" src="//umap.openstreetmap.fr/tr/map/turkiyenin-kara-komsular2_1385351?scaleControl=false&miniMap=false&scrollWheelZoom=true&zoomControl=false&editMode=disabled&moreControl=false&searchControl=false&tilelayersControl=false&embedControl=false&datalayersControl=false&onLoadPanel=none&captionBar=false&captionMenus=false&homeControl=false&fullscreenControl=false&captionControl=false&locateControl=false&measureControl=false&printControl=false#6/39.104489/35.397949"></iframe>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr", gap:"12px", alignItems:"start" }}>
            <iframe title="Türkiye'nin Deniz Komşuları" style={{ width: "100%", height: "800px", border: 0, borderRadius: "12px" }} allowFullScreen allow="geolocation" src="//umap.openstreetmap.fr/tr/map/turkiyenin-deniz-komsular_1384393?scaleControl=false&miniMap=false&scrollWheelZoom=true&zoomControl=false&editMode=disabled&moreControl=false&searchControl=false&tilelayersControl=false&embedControl=false&datalayersControl=false&onLoadPanel=none&captionBar=false&captionMenus=false&homeControl=false&fullscreenControl=false&captionControl=false&locateControl=false&measureControl=false&printControl=false#5/38.976492/34.716797"></iframe>
