    ...
    <>
      <header className="w-full bg-card/70 backdrop-blur-md border-b border-border/20 p-4 sticky top-0 z-40 shadow-sm">
        <div className="container mx-auto flex items-center gap-4">
          <button onClick={() => setSidebarOpen(!isSidebarOpen)} className="p-2 rounded-full text-white bg-blue-600 shadow-[0_0_15px_rgba(37,99,235,0.6)] ring-2 ring-blue-500 animate-pulse" aria-label="Menüyü Aç/Kapat">
            <MapIcon size={24} />
          </button>
